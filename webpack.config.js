...
const scriptPath = resolve(__dirname, "src/quantinuum_docs_theme/assets/scripts");
const staticPath = resolve(__dirname,"src/quantinuum_docs_theme/theme/quantinuum_docs_theme/static");
 ...
 */
 const theme_stylesheets = [
  "styles/quantinuum-docs-theme.css", // all the css created for this specific theme
];
...
module.exports = {
  ...
  devtool: "source-map",
  entry: {
    "quantinuum-docs-theme": resolve(scriptPath, "quantinuum-docs-theme.js"),
